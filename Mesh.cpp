	...
	for (int i = 0;i < 19;++i) {
		for (int j = 0; j < 19; ++j) {
			for (int k = 0; k < 19; ++k) {
				...
				gridcell.val[1] = points.pos[i  ][j  ][k+1];
				gridcell.p[1].x = (((double)(i)   - 10) / 10);
				gridcell.p[1].y = (((double)(j)   - 10) / 10);
				gridcell.p[1].z = (((double)(k+1) - 10) / 10);
				gridcell.val[2] = points.pos[i+1][j  ][k  ];
				gridcell.p[2].x = (((double)(i+1) - 10) / 10);
				gridcell.p[2].y = (((double)(j)   - 10) / 10);
				gridcell.p[2].z = (((double)(k)   - 10) / 10);
				gridcell.val[3] = points.pos[i+1][j  ][k+1];
				gridcell.p[3].x = (((double)(i+1) - 10) / 10);
				gridcell.p[3].y = (((double)(j)   - 10) / 10);
				gridcell.p[3].z = (((double)(k+1) - 10) / 10);
				gridcell.val[4] = points.pos[i  ][j+1][k  ];
				gridcell.p[4].x = (((double)(i)   - 10) / 10);
				gridcell.p[4].y = (((double)(j+1) - 10) / 10);
				gridcell.p[4].z = (((double)(k)   - 10) / 10);
				gridcell.val[5] = points.pos[i  ][j+1][k+1];
				gridcell.p[5].x = (((double)(i)   - 10) / 10);
				gridcell.p[5].y = (((double)(j+1) - 10) / 10);
				gridcell.p[5].z = (((double)(k+1) - 10) / 10);
				gridcell.val[6] = points.pos[i+1][j+1][k  ];
				gridcell.p[6].x = (((double)(i+1) - 10) / 10);
				gridcell.p[6].y = (((double)(j+1) - 10) / 10);
				gridcell.p[6].z = (((double)(k)   - 10) / 10);
				gridcell.val[7] = points.pos[i+1][j+1][k+1];
				gridcell.p[7].x = (((double)(i+1) - 10) / 10);
